package com.BajajHashGenerator;
...
public class BajajPRNHashGenerator {

	public static void main(String[] args) {
		if (args.length != 2) {
			System.out.println("Usage: java -jar BajajPRNHashGenerator.jar 240340120115 ");
			return;
		}
		...
		try {
			...
			String randomString = generateRandomStrings(10);
